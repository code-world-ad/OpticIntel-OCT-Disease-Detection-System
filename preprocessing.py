...
parser.add_argument('--dataset_folder', type=str, default='./dataset/OCTDL', help='path to dataset folder')
parser.add_argument('--labels_path', type=str, default='./dataset/OCTDL_labels.csv', help='path to labels.csv')
